...
const HeroSection = () => {
  return (
    <div
      className="w-full h-96 flex bg-secondaryColor
    overflow-hidden"
    >
      <div className="w-1/2 h-full flex flex-col items-center justify-center text-center p-6 gap-4 italic">
        <h3 className="text-xl md:text-3xl lg:text-5xl text-textPrimary drop-shadow-2xl">
          Where every print
          <br></br>
          begins its journey -
          <span className="text-xl md:text-3xl lg:text-5xl text-primaryColor">
            {" "}
            Hillside Prints{" "}
          </span>
        </h3>
      ...
      <div className="w-1/2 h-full object-cover object-center relative flex items-center justify-center">
        <div className="w-full h-full flex flex-col items-center justify-center text-center p-6 gap-4 z-10">
          <h3 className="text-xl md:text-3xl lg:text-5xl text-background drop-shadow-2xl italic">
            Printed with purpose
            <br></br>
            over 3 Generations -<br></br>
            <span className="text-primaryColor">A Family Tradition</span>
          </h3>
